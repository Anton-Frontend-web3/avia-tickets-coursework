                    ...
                    <TooltipProvider>
						<Tooltip>
							<TooltipTrigger asChild>
								<div className='text-muted-foreground flex cursor-help items-center gap-1 text-[10px] opacity-70 hover:opacity-100 transition-opacity'>
				...
				<div className='flex items-center justify-between gap-4'>
					...
					<div className='text-right'>
                        <div className='flex items-start justify-end gap-0.5'>
                            ...
                            {isNextDay && <sup className='text-[10px] font-bold text-red-500'>+1</sup>}
                        </div>
                        {/* UTC Offset */}
						<p className='text-[10px] font-medium text-blue-600 dark:text-blue-400 mt-1'>
                            {arrOffset}

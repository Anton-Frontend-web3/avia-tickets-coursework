...
export async function GET(
  ...
  try {
    const sqlQuery = `
      SELECT f.flight_id, s.flight_number, f.departure_datetime, f.arrival_datetime, f.base_price,
             ...
             arl.name AS airline_name, arl.logo_url, am.model_name as aircraft_model
      FROM Flights f
